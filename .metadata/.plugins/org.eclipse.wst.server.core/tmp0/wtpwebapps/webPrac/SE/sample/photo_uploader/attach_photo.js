    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/board.write.uploadFile.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/board.write.singleImg.do',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + 'board.write.do',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
